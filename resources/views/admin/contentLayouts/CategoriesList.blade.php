  ...
  <div class="table-wrapper">
    <div class="table-title">
      <div class="row">
        ...
        <div class="col-sm-6">
          <a href="/category/create" class="btn btn-success" rel="cat_modal" data-toggle="modal"
            data-target="#add-category"> <span>Add New
              Category</span></a>
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody id="show-category">
        ...
        <tr>
          ...
          <td>
            <div>
              <button href="/category/{{$category->url}}/edit" type="button" class="btn btn-primary btn-sm"
                data-toggle="modal" data-target="#edit-modal">edit</button>
              <button href="/category/{{$category->url}}/delete" type="button" class="btn btn-danger btn-sm"
                data-toggle="modal" data-target="#delete-category">delete</button>
            </div>
