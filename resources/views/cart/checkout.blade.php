...
<div class="bg-overlay py-4">
    ...
    <div class="container bg-light">
        <div class="table-responsive cart_info ">
            <table class="table table-condensed table-bordered overflow-hidden">
                <thead>
                    <tr>
                        @if(session('status'))
                    ...
                    <tr class="cart_menu badge-info">
                        ...
                        <td class="del_checkout">Actions</td>
                    </tr>
                </thead>
                <?php $count =1;?>
                            ...
                            <form action="{{ url('/addCheckOut') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lastname" type="text" name="contact" placeholder="Contact"
                                            class="form-control">
                                        <br>
